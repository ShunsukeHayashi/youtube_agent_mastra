/**
 * Vercel AI SDKを使用したYouTubeタイトル生成ワークフローのテストスクリプト
 */
import { youtubeTitleGeneratorVercelAI } from './src/mastra/workflows/titleGeneratorWorkflow.vercel-ai';

async function testVercelAIWorkflow() {
    try {
        console.log('Vercel AI SDKを使用したYouTubeタイトル生成ワークフローのテストを開始します...');
